...
def munge_df(df):
    ...
    # Remove outliers
# =============================================================================
#     df = (df.loc[df['THC'] < 100]) # Impossible to have THC content greater than 100%
# =============================================================================
...
def content_feature(df):
    content = pd.read_csv(r'C:\Users\family3340\metis\Project_Luther\I_502.csv', encoding='iso-8859-1')
...
def get_strain_info():
    chromedriver = "C:/Users/family3340/chromedriver" # path to the chromedriver executable
